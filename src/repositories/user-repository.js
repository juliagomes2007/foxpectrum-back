...
var IUser_1 = require("../models/user/IUser");
var UserRepository = /** @class */ (function () {
    ...
    UserRepository.prototype.save = function (user) {
        return __awaiter(this, void 0, void 0, function () {
            ...
            return __generator(this, function (_a) {
                switch (_a.label) {
                    case 0:
                        User = (0, mongoose_1.model)('User', IUser_1.userSchema);
                        userData = new User(__assign({}, user));
                        _a.label = 1;
                    case 1:
                        _a.trys.push([1, 4, , 5]);
    ...
    UserRepository.prototype.update = function (_id, todo) {
        return __awaiter(this, void 0, void 0, function () {
            var User, error_3;
            return __generator(this, function (_a) {
                switch (_a.label) {
                    ...
                    case 2:
                        _a.sent();
                        return [4 /*yield*/, User.updateOne({ _id: _id }, __assign({}, todo))];
    ...
    UserRepository.prototype.deleteById = function (_id) {
        return __awaiter(this, void 0, void 0, function () {
            var User, error_4;
            return __generator(this, function (_a) {
                switch (_a.label) {
                    ...
                    case 2:
                        _a.sent();
                        return [4 /*yield*/, User.deleteOne({ _id: _id })];
                    case 3: return [2 /*return*/, _a.sent()];
                    case 4:
                        error_4 = _a.sent();
                        console.log(error_4);
